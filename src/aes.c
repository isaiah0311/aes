...
static const uint8_t inv_s[256] = { 0x52, 0x09, 0x6A, 0xD5, 0x30, 0x36, 0xA5,
...
static void inv_mix_columns(uint8_t state[4][4]) {
    for (int i = 0; i < 4; ++i) {
        const uint8_t a[4] = { state[0][i], state[1][i], state[2][i],
            state[3][i] };
        const uint8_t b[4] = { gf(a[0], 0x0e) ^ gf(a[1], 0x0b) ^
                gf(a[2], 0x0d) ^ gf(a[3], 0x09),
            gf(a[0], 0x09) ^ gf(a[1], 0x0e) ^ gf(a[2], 0x0b) ^ gf(a[3], 0x0d),
            gf(a[0], 0x0d) ^ gf(a[1], 0x09) ^ gf(a[2], 0x0e) ^ gf(a[3], 0x0b),
            gf(a[0], 0x0b) ^ gf(a[1], 0x0d) ^ gf(a[2], 0x09) ^ gf(a[3], 0x0e) };
